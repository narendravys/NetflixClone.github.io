...
<div>	<a href=netflixlogout class=sign_out_btn>Sign Out</a></div>
		...
		<nav class=lineinfo>
			<a class= b1 id=firstb1 href=premiumlight><i class="bi bi-house"style="margin-right:3px;"></i><b>Home</b></a>
			 <a class=b1>Tv Shows</a> <a class=b1>Movies</a>
			<a class=b1>New & Popular</a> <a class=b1>My List</a>
			<a class="b2" href="premiumhome">Dark Mode&nbsp;<i class="bi bi-moon"></i></a>
